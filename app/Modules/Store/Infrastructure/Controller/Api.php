    ...
    public function getLastProductOrders()
    {
        ...
        foreach ($productOrders as $productOrder) {
            ...
            if ($productOrder->created_at > $nowMinus30sec) {
                ...
                $response[] = '<div class="flex items-center justify-center" style="max-height: 100px"><div><img src="' . $userProfile->avatar . '" style="max-height: 100px" /></div><div class="grow">' . $productOrder->product->name . ' por <span style="color: #FC9208">' . $productOrder->user->name . '</span>.</div></div>';
            }
        }
