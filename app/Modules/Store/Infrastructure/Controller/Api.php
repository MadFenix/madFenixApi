    ...
    public function getLastProductOrders()
    {
        ...
        foreach ($productOrders as $productOrder) {
            ...
            if ($productOrder->created_at > $nowMinus30sec) {
                ...
                $response[] = '<div class="flex items-center space-x-3 justify-center" style="max-height: 200px"><div><img src="' . $userProfile->avatar . '" class="border-2 border-madfenix-gray" style="max-height: 200px" /></div><div class="grow">' . $productOrder->product->name . ' por <span style="color: #FC9208">' . $productOrder->user->name . '</span>.</div></div>';
            }
        }
