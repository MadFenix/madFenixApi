...
class TwitchApiGetCustomChannelRewardRedemptions extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'get-twitch-get-custom-channel-reward-redemptions {user_access_token?} {user_id?}';
    ...
    public function handle(): void
    {
        ...
        echo json_encode($apiHelix->getCustomChannelRewardRedemptions());
    }
}
